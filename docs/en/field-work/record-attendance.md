...
![Start Day with the demonstration Team, Compartment and Harvest Group selected](../assets/screenshots/field/attendance-01-start-day.png)
...
![Attendance roster filtered to the selected demonstration Harvest Group](../assets/screenshots/field/attendance-02-filtered-roster.png)

![Attendance actions after a demonstration employee was clocked in](../assets/screenshots/field/attendance-03-post-clock-in.png)
...
![Attendance roster showing a demonstration employee with Mop-up status](../assets/screenshots/field/attendance-04-mop-up-state.png)
...
![Confirmation shown before Clock Out All is applied](../assets/screenshots/field/attendance-05-clock-out-all-confirm.png)
...
![Final demonstration attendance roster with clocked-out and absence statuses](../assets/screenshots/field/attendance-06-final-statuses.png)
