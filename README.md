...
The build generates one self-contained HTML file per selected guide, with essential styles and local images embedded. The launch set covers harvest count submission, harvest count verification and attendance reporting in both languages.
